...
const TabataIcon: React.FC<IconItemProps> = ({classes, filledClasses, filledHighlightsClasses, strokedClasses}) => {
    return (
        <svg width="100%" height="100%" viewBox="0 0 60.58 60.58" className={classes}>
            <title>Tabata</title>
            <g>
                <rect className={`${commonIconStyles.filledHighlight} ${commonIconStyles.primaryStrokeColor} ${filledHighlightsClasses}`} x="3.92" y="12.87" width="43.8" height="43.8"
                      rx="5.73" ry="5.73"/>
                <g className={`${commonIconStyles.filledPrimary} ${filledClasses}`}>
                ...
                <path className={`${strokedClasses} ${commonIconStyles.stroked} ${commonIconStyles.primaryStrokeColor}`}
                ...
                <g className={`${strokedClasses} ${commonIconStyles.stroked} ${commonIconStyles.primaryStrokeColor}`}>
